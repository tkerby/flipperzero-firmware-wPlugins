    ...
    // Handle menu
        ...
        switch (gamePlay.gameState) {
            ...
            case GameState::Game:
                ...
                #ifndef ALT_B_BUTTON
                    #ifndef SAVE_MEMORY_ENEMY
                    if ((justPressed & B_BUTTON) && prince.isEmpty() && (!sameLevelAsPrince || enemy.getHealth() == 0 || prince.getHealth() == 0)) {
                    #else
                    if ((justPressed & B_BUTTON) && prince.isEmpty() && (!sameLevelAsPrince || prince.getHealth() == 0)) {
                    #endif
