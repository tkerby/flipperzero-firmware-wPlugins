...
static Scene adventure_scenes[] = {
    // Scene 0: Title Screen
    {
        .text_lines = {
            ...
            "tower adventure! You must",
            "find your way to escape..."
        },
        .num_lines = 3,
        .num_options = 1,
        .options = {
            {.text = "Start adventure", .target_scene = 1}
        }
    },
    ...
    {
        .text_lines = {
            "The door is locked. You hear",
            "something scratching from",
            "the other side."
        },
        .num_lines = 3,
        .num_options = 2,
    ...
    // Scene 4: Force the door (was Scene 3 before)
    {
        .text_lines = {
            ...
            "But a monster was waiting.",
            "GAME OVER."
        },
        .num_lines = 3,
        .num_options = 1,
        .options = {
            {.text = "Start again", .target_scene = 0}
        }
    },
    ...
    {
        .text_lines = {
            "You climb onto the ledge",
            "and find a hidden passage.",
            "You've escaped!",
            "YOU WIN!"
        },
        .num_lines = 4,
        .num_options = 1,
        .options = {
            {.text = "Play again", .target_scene = 0}
        }
    }
};
