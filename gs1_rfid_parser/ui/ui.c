...
UI* ui_alloc() {
    ...
    view_dispatcher_add_view(ui->view_dispatcher, View_OpenDisplay, widget_get_view(ui->open_scene->open_widget));
    view_dispatcher_add_view(ui->view_dispatcher, View_ScanDisplay, widget_get_view(ui->scan_scene->scan_widget));
    view_dispatcher_add_view(ui->view_dispatcher, View_ParseDisplay, widget_get_view(ui->parse_scene->parse_widget));
    view_dispatcher_add_view(ui->view_dispatcher, View_RawDataDisplay, widget_get_view(ui->raw_data_scene->raw_data_widget));
