...
TransitCardInfo cards[99] = {
    ...
    { 0x004055, "AT HOP (AKL)", "AKL Transport", false},
    { 0x004063, "Travel Pass (DOH)", "QA Rail", true}
    { 0x004078, "nol (DXB)", "RTA", false}
    ...
    { 0x1120EF, "HSL (HEL)", "HRT", false},
    { 0x1201F4, "ITSO (UK)", "ITSO", false},
    { 0x1301F4, "ITSO (UK)", "ITSO", false},
    { 0x1602A0, "ITSO (UK)", "ITSO", false},
    { 0x227508, "Umo", "Cubic", true},
    { 0x3010F2, "ORCA (SEA)", "ORCA", false},
    { 0x314553, "Opal (SYD)", "TfNSW", false},
    { 0x31594F, "Oyster (LHR)", "TfL", true},
    { 0x422201, "Istanbulkart (IST)", "BELBIM", false},
    { 0x422202, "Istanbulkart (IST)", "BELBIM", false},
    { 0x422206, "Istanbulkart (IST)", "BELBIM", false},
    ...
    { 0xE010F2, "Hop Fastpass (PDX)", "TriMet", false},
