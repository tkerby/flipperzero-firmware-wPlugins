...
void nfc_comparator_physical_compare_results_scene_on_enter(void* context) {
   furi_assert(context);
   NfcComparator* nfc_comparator = context;
   ...
   widget_add_button_element(
      ...
      GuiButtonTypeLeft,
      "Again",
      nfc_comparator_physical_compare_results_callback,
      nfc_comparator);
   widget_add_button_element(
      nfc_comparator->views.widget,
      GuiButtonTypeRight,
...
bool nfc_comparator_physical_compare_results_scene_on_event(void* context, SceneManagerEvent event) {
   NfcComparator* nfc_comparator = context;
   bool consumed = false;
...
void nfc_comparator_physical_compare_results_scene_on_exit(void* context) {
   furi_assert(context);
   NfcComparator* nfc_comparator = context;
