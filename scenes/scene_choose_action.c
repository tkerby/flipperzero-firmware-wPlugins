...
void desfire_app_scene_choose_action_on_enter(void* context){
    ...
    submenu_add_item(
        submenu, "Set Key", MfDesSubmenuSetKey, mfdes_submenu_callback, instance);
    submenu_add_item(
        submenu, "Legacy Authetication", MfDesSubmenuAuthenticate, mfdes_submenu_callback, instance);
