...
void nfc_comparator_physical_finder_scan_scene_on_enter(void* context) {
   ...
   nfc_comparator->worker.nfc_comparator_finder_worker =
      nfc_comparator_finder_worker_alloc(&nfc_comparator->worker.finder_compare_checks);

   nfc_comparator_finder_worker_start(nfc_comparator->worker.nfc_comparator_finder_worker);
      ...
      case NfcComparatorFinderWorkerState_Stopped:
         ...
         if(!force_quit) {
            ...
            FURI_LOG_I(
               "NFC Comparator",
               "UID: %s\nUID length: %s\nProtocol: %s\nPath: %s",
               nfc_comparator->worker.finder_compare_checks.uid ? "Match" : "Mismatch",
               nfc_comparator->worker.finder_compare_checks.uid_length ? "Match" : "Mismatch",
               nfc_comparator->worker.finder_compare_checks.protocol ? "Match" : "Mismatch",
...
void nfc_comparator_physical_finder_scan_scene_on_exit(void* context) {
   ...
   nfc_comparator_finder_worker_free(nfc_comparator->worker.nfc_comparator_finder_worker);
}
