...
void drawVLine(int16_t x, int16_t start_y, int16_t end_y, uint16_t intensity, Draw *const canvas, uint16_t color = TFT_BROWN);
...
void drawChar(int16_t x, int16_t y, char ch, Draw *const canvas, int16_t color = TFT_RED);
