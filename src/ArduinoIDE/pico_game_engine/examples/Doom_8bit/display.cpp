...
void drawVLine(int16_t x, int16_t start_y, int16_t end_y, uint16_t intensity, Draw *const canvas, uint16_t color)
{
...
void drawPixel(int16_t x, int16_t y, uint16_t color, bool raycasterViewport, Draw *const canvas)
{
...
void drawBitmap(
    ...
    int16_t h,
    uint16_t color,
    Draw *const canvas, bool is_8bit)
{
#ifdef PicoEngine
...
void drawChar(int16_t x, int16_t y, char ch, Draw *const canvas, int16_t color)
{
    uint8_t lsb;
    uint8_t c = 0;
...
void fadeScreen(uint16_t intensity, uint16_t color, Draw *const canvas)
{
