...
typedef struct
{
    ...
    uint32_t biSizeImage;    // Specifies the size, in bytes, of the image. This can be set to 0 for BI_RGB bitmaps.
    ...
    uint32_t biClrImportant; // Specifies the number of important colors used, or 0 when every color is important.
} BMPInfoHeader;
#pragma pack(pop)
