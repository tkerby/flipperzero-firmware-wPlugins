...
bool FlipDownloaderRun::downloadApp(const char* appId, const char* buildId, const char* category) {
    ...
    idleCheckCounter = 0;
    snprintf(
        savePath, sizeof(savePath), STORAGE_EXT_PATH_PREFIX "/apps/%s/%s.fap", category, appId);
...
bool FlipDownloaderRun::downloadCategoryInfo(FlipperAppCategory category, uint8_t iteration) {
    ...
    snprintf(
        url,
        sizeof(url),
        "https://catalog.flipperzero.one/api/v0/0/application?limit=%d&is_latest_release_version=true&offset=%d&sort_by=updated_at&sort_order=-1&category_id=%s",
        MAX_RECEIVED_APPS,
        iteration,
        getAppCategoryId(category));
    return app->httpDownloadFile(savePath, url);
}
...
bool FlipDownloaderRun::downloadFile(FlipDownloaderDownloadLink link) {
    ...
    case DownloadLinkFlipperHTTPESP32C3Link1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C3/flipper_http_bootloader_esp32_c3.bin");
    case DownloadLinkFlipperHTTPESP32C3Link2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C3/flipper_http_firmware_a_esp32_c3.bin");
    case DownloadLinkFlipperHTTPESP32C3Link3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C3/flipper_http_partitions_esp32_c3.bin");
        // FlipperHTTP (ESP32-C5)
    case DownloadLinkFlipperHTTPESP32C5Link1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C5/flipper_http_bootloader_esp32_c5.bin");
    case DownloadLinkFlipperHTTPESP32C5Link2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C5/flipper_http_firmware_a_esp32_c5.bin");
    case DownloadLinkFlipperHTTPESP32C5Link3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C5/flipper_http_partitions_esp32_c5.bin");
        // FlipperHTTP (ESP32-C6)
    case DownloadLinkFlipperHTTPESP32C6Link1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C6/flipper_http_bootloader_esp32_c6.bin");
    case DownloadLinkFlipperHTTPESP32C6Link2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C6/flipper_http_firmware_a_esp32_c6.bin");
    case DownloadLinkFlipperHTTPESP32C6Link3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-C6/flipper_http_partitions_esp32_c6.bin");
        // FlipperHTTP (ESP32-Cam)
    case DownloadLinkFlipperHTTPESP32CamLink1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-Cam/flipper_http_bootloader_esp32_cam.bin");
    case DownloadLinkFlipperHTTPESP32CamLink2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-Cam/flipper_http_firmware_a_esp32_cam.bin");
    case DownloadLinkFlipperHTTPESP32CamLink3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-Cam/flipper_http_partitions_esp32_cam.bin");
        // FlipperHTTP (ESP32-S3)
    case DownloadLinkFlipperHTTPESP32S3Link1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-S3/flipper_http_bootloader_esp32_s3.bin");
    case DownloadLinkFlipperHTTPESP32S3Link2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-S3/flipper_http_firmware_a_esp32_s3.bin");
    case DownloadLinkFlipperHTTPESP32S3Link3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-S3/flipper_http_partitions_esp32_s3.bin");
        // FlipperHTTP (ESP32-WROOM)
    case DownloadLinkFlipperHTTPESP32WROOMLink1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-WROOM/flipper_http_bootloader_esp32_wroom.bin");
    case DownloadLinkFlipperHTTPESP32WROOMLink2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-WROOM/flipper_http_firmware_a_esp32_wroom.bin");
    case DownloadLinkFlipperHTTPESP32WROOMLink3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-WROOM/flipper_http_partitions_esp32_wroom.bin");
        // FlipperHTTP (ESP32-WROVER)
    case DownloadLinkFlipperHTTPESP32WROVERLink1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-WROVER/flipper_http_bootloader_esp32_wrover.bin");
    case DownloadLinkFlipperHTTPESP32WROVERLink2:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-WROVER/flipper_http_firmware_a_esp32_wrover.bin");
    case DownloadLinkFlipperHTTPESP32WROVERLink3:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/ESP32-WROVER/flipper_http_partitions_esp32_wrover.bin");
        // FlipperHTTP (PicoCalc W)
    case DownloadLinkFlipperHTTPPicoCalcWLink1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/PicoCalc/flipper_http_picocalc_w.uf2");
        // FlipperHTTP (PicoCalc 2W)
    case DownloadLinkFlipperHTTPPicoCalc2WLink1:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/PicoCalc/flipper_http_picocalc_2w.uf2");
        // FlipperHTTP (VGM)
    case DownloadLinkVGMFlipperHTTP:
        return app->httpDownloadFile(
            savePath,
            "https://raw.githubusercontent.com/jblanked/FlipperHTTP/main/Video%20Game%20Module/C%2B%2B/flipper_http_vgm_c%2B%2B.uf2");
        // Picoware (VGM)
            ...
            if(currentCategory != CategoryUnknown) {
                ...
                if(idleCheckCounter > 3) // Wait a few cycles before checking
                {
                    ...
                    snprintf(
                        ...
                        STORAGE_EXT_PATH_PREFIX "/apps_data/%s/%s.json",
                        APP_ID,
                        getAppCategory(currentCategory));
                    Storage* storage = static_cast<Storage*>(furi_record_open(RECORD_STORAGE));
...
void FlipDownloaderRun::drawMainMenu(Canvas* canvas) {
    const char* menuItems[5] = {
        "App Catalog", "ESP32 Firmware", "FlipperHTTP Firmware", "VGM Firmware", "GitHub Repo"};
    drawMenu(canvas, selectedIndexMain, menuItems, 5);
}

void FlipDownloaderRun::drawMenu(
    Canvas* canvas,
...
const char* FlipDownloaderRun::findNthArrayObject(const char* text, uint8_t index) {
    ...
    FURI_LOG_E(
        TAG, "Failed to find object at index %d, only found %d objects", index, objectCount);
    return nullptr;
}

const char* FlipDownloaderRun::findStringValue(
    const char* text,
    const char* key,
    char* buffer,
    size_t bufferSize) {
...
FlipperAppCategory FlipDownloaderRun::getAppCategory(const char* category) {
    if(strcmp(category, "Bluetooth") == 0) return CategoryBluetooth;
    if(strcmp(category, "Games") == 0) return CategoryGames;
    if(strcmp(category, "GPIO") == 0) return CategoryGPIO;
    if(strcmp(category, "Infrared") == 0) return CategoryInfrared;
    if(strcmp(category, "iButton") == 0) return CategoryIButton;
    if(strcmp(category, "Media") == 0) return CategoryMedia;
    if(strcmp(category, "NFC") == 0) return CategoryNFC;
    if(strcmp(category, "RFID") == 0) return CategoryRFID;
    if(strcmp(category, "Sub-GHz") == 0) return CategorySubGHz;
    if(strcmp(category, "Tools") == 0) return CategoryTools;
    if(strcmp(category, "USB") == 0) return CategoryUSB;
...
const char* FlipDownloaderRun::getAppCategoryId(const char* category) {
    ...
    if(strcmp(category, "GPIO") == 0) return "64971d106617ba37a4bc79b9";
    if(strcmp(category, "Infrared") == 0) return "64971d106617ba37a4bc79b6";
    if(strcmp(category, "iButton") == 0) return "64971d11be1a76c06747de29";
    if(strcmp(category, "Media") == 0) return "64971d116617ba37a4bc79bc";
    if(strcmp(category, "NFC") == 0) return "64971d10be1a76c06747de26";
    if(strcmp(category, "RFID") == 0) return "64971d10577d519190ede5c2";
    if(strcmp(category, "Sub-GHz") == 0) return "64971d0f6617ba37a4bc79b3";
    if(strcmp(category, "Tools") == 0) return "64971d11577d519190ede5c5";
    if(strcmp(category, "USB") == 0) return "64971d11be1a76c06747de2c";
    return NULL;
}
...
std::unique_ptr<FlipperAppInfo>
    FlipDownloaderRun::getAppInfo(FlipperAppCategory category, uint8_t index) {
    char savePath[128];
    snprintf(
        savePath,
        sizeof(savePath),
    ...
    if(!findStringValue(
           currentVersionStart, "short_description", valueBuffer, sizeof(valueBuffer))) {
...
void FlipDownloaderRun::setSavePath(FlipDownloaderDownloadLink link) {
    ...
    case DownloadLinkFirmwareMarauderLink1:
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/Marauder");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/Marauder/esp32_marauder.ino.bootloader.bin");
        break;
    case DownloadLinkFirmwareMarauderLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/Marauder/esp32_marauder.ino.partitions.bin");
        break;
    case DownloadLinkFirmwareMarauderLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/Marauder/esp32_marauder_v1_6_2_20250531_flipper.bin");
        break;
        // Black Magic (ESP32)
    case DownloadLinkFirmwareBlackMagicLink1:
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/Black Magic");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/Black Magic/bootloader.bin");
        break;
    case DownloadLinkFirmwareBlackMagicLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/Black Magic/partition-table.bin");
        break;
    case DownloadLinkFirmwareBlackMagicLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/Black Magic/blackmagic.bin");
        break;
        // FlipperHTTP (WiFi Devboard)
    case DownloadLinkFlipperHTTPWiFiDevboardLink1:
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/WiFi-Devboard");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/WiFi-Devboard/flipper_http_bootloader.bin");
        break;
    case DownloadLinkFlipperHTTPWiFiDevboardLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/WiFi-Devboard/flipper_http_firmware_a.bin");
        break;
    case DownloadLinkFlipperHTTPWiFiDevboardLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/WiFi-Devboard/flipper_http_partitions.bin");
        break;
        // FlipperHTTP (ESP32-C3)
    case DownloadLinkFlipperHTTPESP32C3Link1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-C3");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C3/flipper_http_bootloader_esp32_c3.bin");
        break;
    case DownloadLinkFlipperHTTPESP32C3Link2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C3/flipper_http_firmware_a_esp32_c3.bin");
        break;
    case DownloadLinkFlipperHTTPESP32C3Link3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C3/flipper_http_partitions_esp32_c3.bin");
        break;
        // FlipperHTTP (ESP32-C5)
    case DownloadLinkFlipperHTTPESP32C5Link1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-C5");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C5/flipper_http_bootloader_esp32_c5.bin");
        break;
    case DownloadLinkFlipperHTTPESP32C5Link2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C5/flipper_http_firmware_a_esp32_c5.bin");
        break;
    case DownloadLinkFlipperHTTPESP32C5Link3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C5/flipper_http_partitions_esp32_c5.bin");
        break;
        // FlipperHTTP (ESP32-C6)
    case DownloadLinkFlipperHTTPESP32C6Link1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-C6");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C6/flipper_http_bootloader_esp32_c6.bin");
        break;
    case DownloadLinkFlipperHTTPESP32C6Link2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C6/flipper_http_firmware_a_esp32_c6.bin");
        break;
    case DownloadLinkFlipperHTTPESP32C6Link3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-C6/flipper_http_partitions_esp32_c6.bin");
        break;
        // FlipperHTTP (ESP32-Cam)
    case DownloadLinkFlipperHTTPESP32CamLink1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-Cam");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-Cam/flipper_http_bootloader_esp32_cam.bin");
        break;
    case DownloadLinkFlipperHTTPESP32CamLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-Cam/flipper_http_firmware_a_esp32_cam.bin");
        break;
    case DownloadLinkFlipperHTTPESP32CamLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-Cam/flipper_http_partitions_esp32_cam.bin");
        break;
        // FlipperHTTP (ESP32-S3)
    case DownloadLinkFlipperHTTPESP32S3Link1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-S3");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-S3/flipper_http_bootloader_esp32_s3.bin");
        break;
    case DownloadLinkFlipperHTTPESP32S3Link2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-S3/flipper_http_firmware_a_esp32_s3.bin");
        break;
    case DownloadLinkFlipperHTTPESP32S3Link3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-S3/flipper_http_partitions_esp32_s3.bin");
        break;
        // FlipperHTTP (ESP32-WROOM)
    case DownloadLinkFlipperHTTPESP32WROOMLink1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROOM");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROOM/flipper_http_bootloader_esp32_wroom.bin");
        break;
    case DownloadLinkFlipperHTTPESP32WROOMLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROOM/flipper_http_firmware_a_esp32_wroom.bin");
        break;
    case DownloadLinkFlipperHTTPESP32WROOMLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROOM/flipper_http_partitions_esp32_wroom.bin");
        break;
        // FlipperHTTP (ESP32-WROVER)
    case DownloadLinkFlipperHTTPESP32WROVERLink1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROVER");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROVER/flipper_http_bootloader_esp32_wrover.bin");
        break;
    case DownloadLinkFlipperHTTPESP32WROVERLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROVER/flipper_http_firmware_a_esp32_wrover.bin");
        break;
    case DownloadLinkFlipperHTTPESP32WROVERLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/ESP32-WROVER/flipper_http_partitions_esp32_wrover.bin");
        break;
        // FlipperHTTP (PicoCalc W)
    case DownloadLinkFlipperHTTPPicoCalcWLink1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/PicoCalcW");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/PicoCalcW/flipper_http_picocalc_w.uf2");
        break;
        // FlipperHTTP (PicoCalc 2W)
    case DownloadLinkFlipperHTTPPicoCalc2WLink1:
        snprintf(
        ...
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/FlipperHTTP/PicoCalc2W");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/PicoCalc2W/flipper_http_picocalc_2w.uf2");
        break;
        // FlipperHTTP (VGM)
    case DownloadLinkVGMFlipperHTTP:
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/vgm/flipper_http_vgm_c++.uf2");
        break;
        // Picoware (VGM)
    case DownloadLinkVGMPicoware:
        snprintf(
            savePath, sizeof(savePath), STORAGE_EXT_PATH_PREFIX "/apps_data/vgm/Picoware-VGM.uf2");
        break;
    default:
        break;
    }
...
void FlipDownloaderRun::updateInput(InputEvent* event) {
    if(event->type == InputTypeShort || event->type == InputTypeLong) {
                    ...
                    if(selectedIndexApps < (MAX_RECEIVED_APPS - 1)) {
                        ...
                        if(!isLoadingNextApps) {
                            ...
                            downloadCategoryInfo(
                                currentCategory, currentAppIteration * MAX_RECEIVED_APPS);
                        }
                    }
                }
            } else {
        ...
        case InputKeyOk:
            ...
            case RunViewFlipperHTTP:
                switch(
                    selectedIndexFlipperHTTP) // {"WiFi Devboard", "ESP32-C3", "ESP32-C5", "ESP32-C6", "ESP32-Cam", "ESP32-S3", "ESP32-WROOM", "ESP32-WROVER", "PicoCalc W", "PicoCalc 2W"};
                {
            ...
            case RunViewApps:
                ...
                {
                    std::unique_ptr<FlipperAppInfo> appInfo =
                        getAppInfo(currentCategory, selectedIndexApps);
                    if(appInfo) {
