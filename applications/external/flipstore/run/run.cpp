...
void FlipDownloaderRun::setSavePath(FlipDownloaderDownloadLink link) {
    ...
    case DownloadLinkFirmwareFlipperHTTPLink1:
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/flipper_http_bootloader.bin");
        break;
    case DownloadLinkFirmwareFlipperHTTPLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/flipper_http_firmware_a.bin");
        break;
    case DownloadLinkFirmwareFlipperHTTPLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            ...
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX
            "/apps_data/esp_flasher/FlipperHTTP/flipper_http_partitions.bin");
        break;
        // Black Magic (ESP32)
    case DownloadLinkFirmwareBlackMagicLink1:
        snprintf(
            directory_path,
            sizeof(directory_path),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/BlackMagic");
        storage_common_mkdir(storage, directory_path);
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/BlackMagic/bootloader.bin");
        break;
    case DownloadLinkFirmwareBlackMagicLink2:
        snprintf(
            directory_path,
        ...
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/BlackMagic/partition-table.bin");
        break;
    case DownloadLinkFirmwareBlackMagicLink3:
        snprintf(
            directory_path,
        ...
        snprintf(
            savePath,
            sizeof(savePath),
            STORAGE_EXT_PATH_PREFIX "/apps_data/esp_flasher/BlackMagic/blackmagic.bin");
        break;
        // FlipperHTTP (VGM)
    case DownloadLinkVGMFlipperHTTP:
        snprintf(
