...
void cipher_input_scene_on_enter(void* context) {
    ...
    case FlipCryptPlayfairKeywordInputScene:
        ...
        text_input_set_result_callback(
            ...
            flip_crypt_text_input_callback,
            app,
            app->playfair_keyword_input,
            app->playfair_keyword_input_size,
            true);
        break;
    case FlipCryptPlayfairDecryptKeywordInputScene:
        text_input_reset(app->text_input);
    ...
    case FlipCryptVigenereKeywordInputScene:
        ...
        text_input_set_result_callback(
            ...
            flip_crypt_text_input_callback,
            app,
            app->vigenere_keyword_input,
            app->vigenere_keyword_input_size,
            true);
        break;
    case FlipCryptVigenereDecryptKeywordInputScene:
        text_input_reset(app->text_input);
...
void flip_crypt_qr_scene_on_enter(void* context) {
    ...
    if(strcmp(app->last_output_scene, "AES") == 0) {
        ...
        qrcodegen_encodeText(
            load_result_generic(APP_DATA_PATH("porta.txt")),
            app->qr_buffer,
            app->qrcode,
            qrcodegen_Ecc_LOW,
            qrcodegen_VERSION_MIN,
        ...
        qrcodegen_encodeText(
            load_result_generic(APP_DATA_PATH("porta_decrypt.txt")),
            app->qr_buffer,
            app->qrcode,
            qrcodegen_Ecc_LOW,
            qrcodegen_VERSION_MIN,
