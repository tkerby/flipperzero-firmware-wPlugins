...
#define uhf_u107_get_hw_version(device, response, response_length)      uhf_u107_info_command(device, 0x00, response, response_length)
#define uhf_u107_get_sw_version(device, response, response_length)      uhf_u107_info_command(device, 0x01, response, response_length)
#define uhf_u107_get_manufacturer(device, response, response_length)    uhf_u107_info_command(device, 0x02, response, response_length)
