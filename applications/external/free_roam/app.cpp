...
void FreeRoamApp::createAppDataPath() {
    ...
    snprintf(
        directory_path, sizeof(directory_path), STORAGE_EXT_PATH_PREFIX "/apps_data/free_roam");
    storage_common_mkdir(storage, directory_path);
    snprintf(
        directory_path,
        sizeof(directory_path),
        STORAGE_EXT_PATH_PREFIX "/apps_data/free_roam/data");
    storage_common_mkdir(storage, directory_path);
...
bool FreeRoamApp::save_char(const char* path_name, const char* value) {
    ...
    snprintf(
        file_path,
        sizeof(file_path),
        STORAGE_EXT_PATH_PREFIX "/apps_data/free_roam/data/%s.txt",
        path_name);
...
FuriString* FreeRoamApp::httpRequest(
    ...
    snprintf(
        ...
        STORAGE_EXT_PATH_PREFIX "/apps_data/free_roam/data/temp.json");
...
FreeRoamApp::FreeRoamApp() {
    ...
    if(!easy_flipper_set_submenu(
           &submenu, FreeRoamViewSubmenu, "Free Roam", callback_exit_app, &viewDispatcher)) {
