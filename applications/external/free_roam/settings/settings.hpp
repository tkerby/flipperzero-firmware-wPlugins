...
public:
    ...
    VariableItem* getWiFiSSIDItem() const {
        return variable_item_wifi_ssid;
    }
    VariableItem* getWiFiPassItem() const {
        return variable_item_wifi_pass;
    }
    VariableItem* getUserNameItem() const {
        return variable_item_user_name;
    }
    VariableItem* getUserPassItem() const {
        return variable_item_user_pass;
    }
};
