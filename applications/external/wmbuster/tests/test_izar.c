...
static void run(const char* name, const char* hex, const char* must_contain) {
    ...
    char mc[4];
    wmbus_manuf_decode(link.M, mc);
    printf(
        "--- %s [M=%s V=%02X T=%02X CI=%02X ID=%08X] ---\n%s\n",
        name,
        mc,
        link.version,
        link.medium,
...
int main(void) {
    ...
    run("IzarWater", "1944304C72242421D401A2 013D4013DD8B46A4999C1293E582CC", "3.488 m3");
    run("IzarWater3", "1944A5117807791948 20A1 21170013355F8EDB2D03C6912B1E37", "4.366 m3");
    run("IzarWater4", "1944304c9c5824210c04 a3 63140013716577ec59e8663ab0d31c", "38.944 m3");
    run("IzarWater5", "1944304CDEFFE420CC01 A2 63120013258F907B0AFF12529AC33B", "159.832 m3");
    run("IzarWater6", "194424238607750350 48 A251520015BEB6B2E1ED623A18FC74A5", "521.602 m3");
