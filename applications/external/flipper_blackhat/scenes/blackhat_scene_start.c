...
BlackhatItem items[] = {
    ...
    {"Connect WiFi", {"wlan0", "wlan1", "wlan2"}, 3, NULL, WIFI_CON_CMD, FOCUS_CONSOLE_END},
    ...
    {"Enable AP", {"wlan0", "wlan1", "wlan2"}, 3, NULL, START_AP_CMD, FOCUS_CONSOLE_END},
    {"Start Kismet", {"wlan0", "wlan1", "wlan2"}, 3, NULL, START_KISMET_CMD, FOCUS_CONSOLE_END},
