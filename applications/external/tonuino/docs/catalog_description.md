...
- **Byte 5**: Folder number (1-99, hex **0x01** to **0x63**)
...
Launch from Apps then NFC then TonUINO Writer. The main menu offers:
...
Install from [Flipper Lab](https://lab.flipper.net) by searching for **TonUINO Writer** and clicking Install.
...
MIT License. See the LICENSE file in the source repository for details.
