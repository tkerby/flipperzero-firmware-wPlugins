...
// E907
static const uint8_t E907_EX1[] =
    {0xE2, 0x00, 0xE9, 0x07, 0x00, 0x22, 0x0F, 0x43, 0x43, 0x41, 0xB0};
static const uint8_t E907_EX2[] =
    {0xE2, 0x00, 0xE9, 0x07, 0x00, 0x22, 0x0F, 0x44, 0x44, 0x41, 0xB0};
...
// E908
static const uint8_t E908_EX1[] =
    {0xE1, 0x00, 0xE9, 0x08, 0x00, 0x0E, 0xD2, 0x55, 0x7C, 0x7C, 0x7C, 0xB0};
static const Entry CAT_E908[] = {{"E9-08 Single 6-bit (ex1)", E908_EX1, sizeof(E908_EX1)}};

// E909
static const uint8_t E909_EX1[] =
    {0xE1, 0x00, 0xE9, 0x09, 0x00, 0x0E, 0x0F, 0xBC, 0xB5, 0xB9, 0xA4, 0xA7, 0xB0};
static const Entry CAT_E909[] = {{"E9-09 5-Color Palette (ex1)", E909_EX1, sizeof(E909_EX1)}};

// E90B
static const uint8_t E90B_EX1[] =
...
// E910
static const uint8_t E910_1[] = {0xE1, 0x00, 0xE9, 0x10, 0x00, 0x13, 0x48, 0x97, 0xD0, 0x0E,
...
// E911
static const uint8_t E911_1[] = {0xE1, 0x00, 0xE9, 0x11, 0x00, 0x6F, 0x0F, 0x56, 0x48, 0x58, 0xF4,
                                 0x48, 0x82, 0xD1, 0x46, 0x02, 0x08, 0xD0, 0x65, 0x00, 0xB0};
static const uint8_t E911_2[] = {0xE2, 0x00, 0xE9, 0x11, 0x00, 0x4F, 0x0F, 0x44, 0x4F, 0x58, 0xF4,
                                 0x48, 0x82, 0xD1, 0x46, 0x06, 0x07, 0xD0, 0x65, 0x43, 0xB0};
static const uint8_t E911_3[] = {0xE1, 0x00, 0xE9, 0x11, 0x00, 0x0F, 0x0F, 0x48, 0x59, 0x58, 0xF4,
                                 0x48, 0x82, 0xD1, 0x46, 0x02, 0x0D, 0xD0, 0x65, 0x05, 0xB0};
static const uint8_t E911_4[] = {0xE2, 0x00, 0xE9, 0x11, 0x00, 0x4F, 0x0F, 0x4F, 0x55, 0x58, 0xF4,
                                 0x48, 0x82, 0xD1, 0x46, 0x02, 0x2A, 0xD0, 0x65, 0x01, 0xB0};
static const uint8_t E911_5[] = {0xE1, 0x00, 0xE9, 0x11, 0x00, 0x01, 0x0F, 0x5A, 0x47, 0x5B, 0xF0,
                                 0x31, 0x34, 0x37, 0x48, 0x94, 0xD1, 0x3D, 0x05, 0x07, 0xB0};
static const uint8_t E911_6[] = {0xE1, 0x00, 0xE9, 0x11, 0x00, 0x07, 0x0F, 0x55, 0x5D, 0x58, 0xF4,
                                 0x48, 0x82, 0xD1, 0x46, 0x05, 0x08, 0xD0, 0x65, 0x00, 0xB0};
static const uint8_t E911_7[] = {0xE1, 0x00, 0xE9, 0x11, 0x00, 0x44, 0x0F, 0x51, 0x42, 0x58, 0xF4,
...
// E912
static const uint8_t E912_EX1[] = {0xE1, 0x00, 0xE9, 0x12, 0x00, 0x01, 0x0F, 0xBC,
                                   0xBD, 0xBD, 0xBD, 0xBD, 0x30, 0xD0, 0x37, 0xF4,
                                   0xD2, 0x46, 0x00, 0x00, 0xFC, 0xBB};
static const uint8_t E912_EX2[] = {0xE1, 0x00, 0xE9, 0x12, 0x00, 0x01, 0x29, 0x04,
                                   0x02, 0x02, 0x11, 0x11, 0x48, 0x96, 0xD0, 0x0E,
                                   0xFF, 0xD1, 0x46, 0x07, 0x07, 0xB0};
static const uint8_t E912_EX3[] = {0xE2, 0x00, 0xE9, 0x12, 0x00, 0x03, 0x0F, 0xA2,
                                   0xA2, 0xA4, 0xA4, 0xA2, 0x30, 0xD0, 0x37, 0xF4,
                                   0xD2, 0x46, 0x00, 0x64, 0xFC, 0xB0};
...
// E913
static const uint8_t E913_1[] = {0xE1, 0x00, 0xE9, 0x13, 0x00, 0x02, 0xD0, 0x37,
                                 0xF0, 0xD2, 0x3D, 0x05, 0x05, 0x00, 0x0E, 0xFA,
                                 0x89, 0x83, 0x51, 0x0E, 0xE7, 0xA0, 0xB0};
static const uint8_t E913_2[] = {0xE2, 0x00, 0xE9, 0x13, 0x00, 0x65, 0x0F, 0xBD,
...
// E914
static const uint8_t E914_1[] = {0xE1, 0x00, 0xE9, 0x14, 0x00, 0x0C, 0xD0, 0x37,
                                 0xF0, 0xD2, 0x3D, 0x05, 0x0C, 0x0C, 0x0E, 0xEC,
                                 0x89, 0x83, 0x51, 0x0E, 0xEE, 0x0C, 0x3D, 0xB0};
static const uint8_t E914_2[] = {0xE2, 0x00, 0xE9, 0x14, 0x00, 0x2C, 0xD0, 0x37,
                                 0xF0, 0xD2, 0x3D, 0x02, 0x12, 0x00, 0x0E, 0xEA,
                                 0x89, 0x83, 0x51, 0x0E, 0xE3, 0x0C, 0x1E, 0xB0};
static const uint8_t E914_3[] = {0xE2, 0x00, 0xE9, 0x14, 0x00, 0x42, 0x0F, 0x55,
...
static void make_packet(uint8_t* _size, uint8_t** _packet, Payload* payload) {
    ...
    case MB_Cat_E905_Single: {
        uint8_t e905[9];
        build_e905(cfg->color5 & 0x1F, cfg->vibe_on, e905);
        adv_len = build_adv(e905, sizeof(e905), adv);
        break;
    }
    case MB_Cat_E906_Dual: {
        const Entry* arr = CAT_E906;
        uint8_t i = cfg->index % (sizeof(CAT_E906) / sizeof(CAT_E906[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E907_Unknown: {
        const Entry* arr = CAT_E907;
        uint8_t i = cfg->index % (sizeof(CAT_E907) / sizeof(CAT_E907[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E908_6bit: {
        const Entry* arr = CAT_E908;
        uint8_t i = cfg->index % (sizeof(CAT_E908) / sizeof(CAT_E908[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E909_5Palette: {
        const Entry* arr = CAT_E909;
        uint8_t i = cfg->index % (sizeof(CAT_E909) / sizeof(CAT_E909[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E90B_Circle: {
        const Entry* arr = CAT_E90B;
        uint8_t i = cfg->index % (sizeof(CAT_E90B) / sizeof(CAT_E90B[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E90C_Animations: {
        const Entry* arr = CAT_E90C;
        uint8_t i = cfg->index % (sizeof(CAT_E90C) / sizeof(CAT_E90C[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E90E_Examples: {
        const Entry* arr = CAT_E90E;
        uint8_t i = cfg->index % (sizeof(CAT_E90E) / sizeof(CAT_E90E[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E90F_Examples: {
        const Entry* arr = CAT_E90F;
        uint8_t i = cfg->index % (sizeof(CAT_E90F) / sizeof(CAT_E90F[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E910_Alternating: {
        const Entry* arr = CAT_E910;
        uint8_t i = cfg->index % (sizeof(CAT_E910) / sizeof(CAT_E910[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E911_Crossfade: {
        const Entry* arr = CAT_E911;
        uint8_t i = cfg->index % (sizeof(CAT_E911) / sizeof(CAT_E911[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E912_CircleVibe: {
        const Entry* arr = CAT_E912;
        uint8_t i = cfg->index % (sizeof(CAT_E912) / sizeof(CAT_E912[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E913_Examples: {
        const Entry* arr = CAT_E913;
        uint8_t i = cfg->index % (sizeof(CAT_E913) / sizeof(CAT_E913[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    case MB_Cat_E914_Examples: {
        const Entry* arr = CAT_E914;
        uint8_t i = cfg->index % (sizeof(CAT_E914) / sizeof(CAT_E914[0]));
        adv_len = build_adv(arr[i].data, arr[i].len, adv);
        break;
    }
    }
...
static void extra_config(Ctx* ctx) {
    ...
    if(cfg->category == MB_Cat_E905_Single) {
        VariableItem* item = variable_item_list_add(
            ctx->variable_item_list, "Vibration", 2, on_bool, &cfg->vibe_on);
