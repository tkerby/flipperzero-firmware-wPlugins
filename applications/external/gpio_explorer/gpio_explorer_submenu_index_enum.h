#ifndef GPIO_EXPLORER_SUBMENU_INDEX_ENUM
#define GPIO_EXPLORER_SUBMENU_INDEX_ENUM

enum gpio_explorer_submenu_index_enum {
...
#endif //GPIO_EXPLORER_SUBMENU_INDEX_ENUM
