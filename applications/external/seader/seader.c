...
#define SEADER_WIEGAND_PLUGIN_PATH                APP_ASSETS_PATH("plugins/seader_plugin_wiegand.fal")
#define SEADER_HF_PLUGIN_PATH                     APP_ASSETS_PATH("plugins/seader_plugin_hf.fal")
