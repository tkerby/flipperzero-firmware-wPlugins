...
// constant variables
uint8_t xsm3_id_data_ms_controller[0x1D] = {0x49, 0x4B, 0x00, 0x00, 0x17, 0x41, 0x41, 0x41,
...
static const uint8_t xsm3_root_key_0x23[0x10] =
    {0x82, 0x80, 0x78, 0x68, 0x3A, 0x52, 0x3A, 0x98, 0x10, 0xF4, 0x0C, 0x12, 0x70, 0x66, 0xDC, 0xBA};

static const uint8_t xsm3_root_key_0x24[0x10] =
    {0x66, 0x62, 0x1A, 0x78, 0xF8, 0x60, 0x9C, 0x8A, 0x26, 0x9A, 0x04, 0xAE, 0xD8, 0x5C, 0x1E, 0xC8};
...
void xsm3_generate_kv_keys(const uint8_t console_id[0x8]) {
    ...
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_root_key_0x23, console_id_hash, 0x10, xsm3_kv_2des_key_1, 1);
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_root_key_0x24, console_id_hash + 0x4, 0x10, xsm3_kv_2des_key_2, 1);
}
...
void xsm3_do_challenge_init(uint8_t challenge_packet[0x22]) {
    ...
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_key_0x1D, challenge_packet + 0x5, 0x18, xsm3_decryption_buffer, 0);
    ...
    UsbdSecXSM3AuthenticationMac(
        xsm3_key_0x1E, NULL, challenge_packet + 5, 0x18, incoming_packet_mac);
    // validate the MAC
    ...
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_kv_2des_key_1, xsm3_random_console_data, 0x10, xsm3_random_console_data_enc, 1);
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_kv_2des_key_2,
        xsm3_random_console_data_swap,
        0x10,
    ...
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_random_console_data_enc,
        xsm3_decryption_buffer,
        0x20,
        xsm3_challenge_response + 0x5,
        1);
...
void xsm3_do_challenge_verify(uint8_t challenge_packet[0x16]) {
    ...
    UsbdSecXSM3AuthenticationCrypt(
        xsm3_random_controller_data, challenge_packet + 0x5, 0x8, xsm3_decryption_buffer, 0);
    ...
    UsbdSecXSM3AuthenticationMac(
        xsm3_challenge_init_hash,
        xsm3_random_console_data,
        challenge_packet + 0x5,
        0x8,
        incoming_packet_mac);
    // validate the MAC
