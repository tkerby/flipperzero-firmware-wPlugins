...
if __name__ == "__main__":
    try:
        ...
        if r.status_code == 200 and len(res) == 0:
            ...
            print(
                "For best results, lower the interval to 1 second and increase power to 6 dBm."
            )
            print(
                "This is not an error! Just be patient or check to make sure the correct .key file is being used."
            )
            print()
