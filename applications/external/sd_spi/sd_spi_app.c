...
void app_scene_on_enter_main_menu(void* context) {
    ...
    submenu_add_item(
        app->menu, "SD Init", AppMenuSelection_Init, app_menu_callback_main_menu, app);
    submenu_add_item(
        app->menu, "SD Status", AppMenuSelection_Status, app_menu_callback_main_menu, app);
    submenu_add_item(
        app->menu, "SD Lock", AppMenuSelection_SDLock, app_menu_callback_main_menu, app);
    submenu_add_item(
        app->menu, "SD Unlock", AppMenuSelection_SDUnLock, app_menu_callback_main_menu, app);
    submenu_add_item(
        app->menu, "SD Force Erase", Confirmation_Dialog, app_menu_callback_main_menu, app);
    submenu_add_item(
        app->menu, "Password", AppMenuSelection_Password, app_menu_callback_main_menu, app);
    submenu_add_item(app->menu, "About", AppMenuSelection_Info, app_menu_callback_main_menu, app);
