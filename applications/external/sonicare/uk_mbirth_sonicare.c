...
static Sonicare* sonicare_alloc(void) {
    ...
    view_dispatcher_set_custom_event_callback(
        app->view_dispatcher, sonicare_debug_custom_event_callback);
    view_dispatcher_set_navigation_event_callback(
        app->view_dispatcher, sonicare_debug_back_event_callback);
    ...
    view_dispatcher_add_view(
        app->view_dispatcher, SonicareViewWidget, widget_get_view(app->widget));
