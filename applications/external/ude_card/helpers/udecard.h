...
// The second occurrence is not checked, due to inconsistent positions
//#define UDECARD_MEMBERTYPE_BYTE_IN_BLOCK_2OCC_A 2
//#define UDECARD_MEMBERTYPE_BYTE_IN_BLOCK_2OCC_B 3
