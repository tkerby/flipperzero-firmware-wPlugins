...
static const EventDef EVENTS[] = {
    ...
    {
        .header = "! ILLNESS",
        .body = {"%s has dysentery.", "Clean water and rest", "are the only cure.", NULL},
        .choices =
            {
        ...
        .weight_low_food = 6,
        .weight_grueling = 4,
        .weight_bad_weather = 2,
        .weight_mountain = 2,
        .weight_desert = 0,
    },
    {
        .header = "! ILLNESS",
        .body = {"%s has typhoid.", "The trail ahead is", "long and difficult.", NULL},
        .choices =
            {
        ...
        .weight_low_food = 4,
        .weight_grueling = 6,
        .weight_bad_weather = 3,
        .weight_mountain = 3,
        .weight_desert = 0,
    },
    {
        .header = "! ILLNESS",
        .body = {"%s has a bad cold.", "Push on or rest", "to recover.", NULL},
        .choices =
            {
    ...
    {
        .header = "! ILLNESS",
        .body = {"%s has pneumonia.", "Mountain cold air", "filled their lungs.", NULL},
        .choices =
            {
                {"Continue on", 0, 0, 0, -2.0f, false},
        ...
        .weight_low_food = 0,
        .weight_grueling = 0,
        .weight_bad_weather = 4,
        .weight_mountain = 8,
        .weight_desert = 0, // mountains only
    },

    // ── Injury ────────────────────────────────────────────────
    {
        .header = "! INJURY",
        .body = {"%s broke an arm", "fixing the wagon.", "Lost 2 days work.", NULL},
        .choices =
            {
                {"Continue on", 0, 0, 0, -1.0f, false},
        ...
        .weight_low_food = 0,
        .weight_grueling = 3,
        .weight_bad_weather = 0,
        .weight_mountain = 2,
        .weight_desert = 0,
    },
    {
        .header = "! INJURY",
        .body = {"%s was bitten by", "a rattlesnake.", "Seek help quickly.", NULL},
        .choices =
            {
                {"Continue on", 0, 0, 0, -2.0f, false},
                {"Rest 4 days", 4, 0, 0, +1.0f, false},
        ...
        .weight_bad_weather = 0,
        .weight_mountain = 0,
        .weight_desert = 6, // desert only
    },

    // ── Wagon trouble ─────────────────────────────────────────
    {
        .header = "WAGON TROUBLE",
        .body = {"An axle cracked on", "the rocky pass.", "Repairs needed.", NULL},
        .choices =
            {
        ...
        .weight_low_food = 0,
        .weight_grueling = 5,
        .weight_bad_weather = 1,
        .weight_mountain = 5,
        .weight_desert = 0,
    },
    {
        .header = "WAGON TROUBLE",
        .body = {"A wheel came off", "crossing the creek.", "The wagon is stuck.", NULL},
        .choices =
            {
    ...
    {
        .header = "WAGON TROUBLE",
        .body = {"The desert heat has", "shrunk the wagon", "wheels dangerously.", NULL},
        .choices =
            {
    ...
    {
        .header = "BAD WEATHER",
        .body = {"Heavy rain has", "turned the trail", "to thick mud.", NULL},
        .choices =
            {
        ...
        .weight_low_food = 0,
        .weight_grueling = 0,
        .weight_bad_weather = 6,
        .weight_mountain = 3,
        .weight_desert = 0,
    },
    {
        .header = "EARLY FROST",
        .body = {"A hard frost has", "hit the Cascades.", "Ice on the trail.", NULL},
        .choices =
            {
    ...
    {
        .header = "BLIZZARD",
        .body = {"A sudden blizzard", "has buried the trail.", "You must wait.", NULL},
        .choices =
            {
    ...
    {
        .header = "FLASH FLOOD",
        .body = {"A wall of water", "swept the trail.", "Take cover!", NULL},
        .choices =
            {
                {"Wait 2 days", 2, 0, 0, 0.0f, false},
    ...
    {
        .header = "GOOD FORTUNE",
        .body = {"You found a trail", "guide who knows", "a faster route!", NULL},
        .choices =
            {
    ...
    {
        .header = "GOOD FORTUNE",
        .body = {"Wild berries along", "the trail.", "+20 lbs of food!", NULL},
        .choices =
            {
    ...
    {
        .header = "GOOD FORTUNE",
        .body = {"A passing merchant", "sells supplies", "at fair prices.", NULL},
        .choices =
            {
    ...
    {
        .header = "! SUPPLIES LOW",
        .body = {"Food is running", "dangerously low.", "Consider hunting.", NULL},
        .choices =
            {
...
static int pick_player(const GameState* gs, int player_index) {
    if(player_index >= 0 && player_index < gs->num_players) return player_index;
...
DayResult day_advance(GameState* gs, ActiveEvent* ev) {
    ...
    bool drain_pace = (t->pace == 2 && day_num % 4 == 0) || (t->pace == 3 && day_num % 2 == 0);
...
bool event_scroll_down(ActiveEvent* ev) {
    ...
    // Count body lines
    int n = 0;
    while(n < MAX_BODY_LINES && ev->def->body[n])
        n++;
