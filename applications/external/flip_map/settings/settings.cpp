...
FlipMapSettings::FlipMapSettings(ViewDispatcher** view_dispatcher, void* appContext)
    ...
    variable_item_location =
        variable_item_list_add(variable_item_list, "Location", 2, callbackLocation, nullptr);
