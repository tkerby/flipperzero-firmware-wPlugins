...
void CANTransceiver_SceneMainMenu_OnEnter(void* pContext)
{
	...
	submenu_add_item(pInstance->pSubmenu, "Receive", CANTransceiver_SceneMainMenu_Receive,
		CANTransceiver_SceneMainMenu_SubmenuCallback, pInstance);
	submenu_add_item(pInstance->pSubmenu, "Transmit", CANTransceiver_SceneMainMenu_Transmit,
		CANTransceiver_SceneMainMenu_SubmenuCallback, pInstance);
	...
	submenu_add_item(pInstance->pSubmenu, "OBD-II Mode", CANTransceiver_SceneMainMenu_OBDIIMode,
		CANTransceiver_SceneMainMenu_SubmenuCallback, pInstance);
#endif
	submenu_add_item(pInstance->pSubmenu, "Setup", CANTransceiver_SceneMainMenu_Setup,
		CANTransceiver_SceneMainMenu_SubmenuCallback, pInstance);
	submenu_add_item(pInstance->pSubmenu, "Wiring", CANTransceiver_SceneMainMenu_Wiring,
		CANTransceiver_SceneMainMenu_SubmenuCallback, pInstance);
	submenu_add_item(pInstance->pSubmenu, "About", CANTransceiver_SceneMainMenu_About,
		CANTransceiver_SceneMainMenu_SubmenuCallback, pInstance);

	submenu_set_selected_item(pInstance->pSubmenu,
...
bool CANTransceiver_SceneMainMenu_OnEvent(void* pContext, SceneManagerEvent event)
{
	...
	{
		scene_manager_set_scene_state(pInstance->pSceneManager, CANTransceiver_SceneMainMenu, event.event);
		switch (event.event)
		{
