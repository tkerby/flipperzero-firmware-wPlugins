...
static void test_bulletin_and_status_strings(void) {
    ...
    TEST_ASSERT_EQUAL_INT(
        (int)strlen(":BLN3     :pj6y bln"), aprs_bulletin(c, sizeof(c), 3, "pj6y bln"));
...
static void test_bulletin_packet_pj6y(void) {
    ...
    for(i = 0; i < (uint16_t)strlen(st_pj6y); i++)
        want[i] = (uint8_t)(st_pj6y[i] == '1');
...
static void test_status_packet_yp0ta(void) {
    ...
    static const uint8_t ax_yp0ta[] = {
        0x82, 0xA0, 0xB4, 0x8C, 0x98, 0xA0, 0x60, 0xB2, 0xA0, 0x60, 0xA8, 0x82, 0x40,
        0x61, 0x03, 0xF0, 0x3E, 0x79, 0x70, 0x30, 0x74, 0x61, 0x20, 0x75, 0x70,
    };
...
static void test_one_message_packet(void) {
    ...
    static const uint8_t ax_yo3gnd[] = {
        0x82, 0xA0, 0xB4, 0x8C, 0x98, 0xA0, 0x60, 0xB2, 0x9E, 0x66, 0x8E, 0x9C, 0x88, 0x63, 0x03,
        0xF0, 0x3A, 0x59, 0x4F, 0x38, 0x59, 0x4C, 0x2D, 0x35, 0x20, 0x20, 0x3A, 0x37, 0x33,
    };

    /* 73 pkt */
    UNITY_SET_DETAILS("aprs", "yo3gnd");
    TEST_ASSERT_EQUAL_INT(
        (int)strlen(":YO8YL-5  :73"), aprs_message(msg, sizeof(msg), "YO8YL", 5, "73"));
...
static void test_jy1_message_packet(void) {
    ...
    static const uint8_t ax_jy1[] = {
        0x82, 0xA0, 0xB4, 0x8C, 0x98, 0xA0, 0x60, 0x94, 0xB2, 0x62, 0x40,
        0x40, 0x40, 0x61, 0x03, 0xF0, 0x3A, 0x59, 0x4F, 0x39, 0x4C, 0x49,
        0x47, 0x2D, 0x32, 0x20, 0x3A, 0x6A, 0x79, 0x31, 0x20, 0x68, 0x69,
    };
    ...
    TEST_ASSERT_EQUAL_INT(
        (int)strlen(":YO9LIG-2 :jy1 hi"), aprs_message(msg, sizeof(msg), "YO9LIG", 2, "jy1 hi"));
...
static void test_yo9lig_message_packet(void) {
    ...
    static const uint8_t ax_yo9lig[] = {
        0x82, 0xA0, 0xB4, 0x8C, 0x98, 0xA0, 0x60, 0xB2, 0x9E, 0x72, 0x98,
        0x92, 0x8E, 0x61, 0x03, 0xF0, 0x3A, 0x59, 0x4F, 0x33, 0x47, 0x4E,
        0x44, 0x2D, 0x31, 0x20, 0x3A, 0x6C, 0x69, 0x67, 0x20, 0x68, 0x69,
    };
    ...
    TEST_ASSERT_EQUAL_INT(
        (int)strlen(":YO3GND-1 :lig hi"), aprs_message(msg, sizeof(msg), "YO3GND", 1, "lig hi"));
...
static void test_pos_packet_yo8yl(void) {
    ...
    static const uint8_t ax_yo8yl_pos[] = {
        0x82, 0xA0, 0xB4, 0x8C, 0x98, 0xA0, 0x60, 0xB2, 0x9E, 0x70, 0xB2, 0x98, 0x40,
        0x79, 0x03, 0xF0, 0x21, 0x34, 0x34, 0x32, 0x36, 0x2E, 0x32, 0x35, 0x4E, 0x2F,
        0x30, 0x32, 0x36, 0x30, 0x35, 0x2E, 0x34, 0x31, 0x45, 0x2D, 0x43, 0x69, 0x73,
        0x6D, 0x69, 0x67, 0x69, 0x75, 0x20, 0x50, 0x61, 0x72, 0x6B,
    };
    ...
    for(i = 0; i < (uint16_t)strlen(st_yo8yl_pos); i++)
        want[i] = (uint8_t)(st_yo8yl_pos[i] == '1');
    TEST_ASSERT_EQUAL_UINT8_ARRAY(want, p.stuffed, p.stuffed_len);
}
...
static void test_loopish_calls(void) {
    const char* win[] = {
        ...
        "DL0LOL", "GB0OTY", "GB4NGS", "HA6RID", "SO2NIC", "3Z3Z3Z", "YO0F",   "YP3PE",
        "VB2CAP", "K0K",    "K4B",    "K3T",    "DU0W0",

        "OO0F",   "OR4L",   "GB0NGO", "G4SSY",  "G1SUS",  "TM5OON", "VA6INA", "VC7F",
        "K3K",    "K4T",    "N9E",    "W4L",    "K1D",    "K1L",    "W3B",
    ...
    const char* lose[] = {
        ...
        "TM1SSOU",    "TM0RBIN",    "VB4LIGMA",   "VB3YEET",  "VC9CATGIRL", "VC3DEEZ",
        "VB3HARAMBE", "VC3RIKROLL", "VB6DANK",
    };
    Packet p;
    char msg[160];
    char payload[160];
