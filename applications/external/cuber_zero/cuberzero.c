...
int32_t cuberzeroMain(const void* const pointer) {
    ...
    const AppSceneOnEnterCallback onEnter[] = {
        (AppSceneOnEnterCallback)SceneAboutEnter,
    ...
    view_dispatcher_set_navigation_event_callback(
        instance->dispatcher, (ViewDispatcherNavigationEventCallback)callbackNavigationEvent);
    view_dispatcher_add_view(
        instance->dispatcher, CUBERZERO_VIEW_SUBMENU, submenu_get_view(instance->view.submenu));
    view_dispatcher_add_view(
        instance->dispatcher,
