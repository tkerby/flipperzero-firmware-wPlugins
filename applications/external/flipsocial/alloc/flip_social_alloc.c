...
FlipSocialApp* flip_social_app_alloc() {
    ...
    view_dispatcher_set_custom_event_callback(
        app->view_dispatcher, flip_social_custom_event_callback);
    // Main view
    if(!easy_flipper_set_view(
           &app->view_loader,
           FlipSocialViewLoader,
           flip_social_loader_draw_callback,
           NULL,
    ...
    app->variable_item_logged_out_wifi_settings_ssid = variable_item_list_add(
        app->variable_item_list_logged_out_wifi_settings, "SSID", 1, NULL, app);
    app->variable_item_logged_out_wifi_settings_password = variable_item_list_add(
        app->variable_item_list_logged_out_wifi_settings, "Password", 1, NULL, app);
    //
    app->variable_item_logged_out_login_username =
        variable_item_list_add(app->variable_item_list_logged_out_login, "Username", 1, NULL, app);
    app->variable_item_logged_out_login_password =
        variable_item_list_add(app->variable_item_list_logged_out_login, "Password", 1, NULL, app);
    app->variable_item_logged_out_login_button =
        variable_item_list_add(app->variable_item_list_logged_out_login, "Login", 0, NULL, app);
    //
    app->variable_item_logged_out_register_username = variable_item_list_add(
        app->variable_item_list_logged_out_register, "Username", 1, NULL, app);
    app->variable_item_logged_out_register_password = variable_item_list_add(
        app->variable_item_list_logged_out_register, "Password", 1, NULL, app);
    app->variable_item_logged_out_register_password_2 = variable_item_list_add(
        app->variable_item_list_logged_out_register, "Confirm Password", 1, NULL, app);
    app->variable_item_logged_out_register_button = variable_item_list_add(
        app->variable_item_list_logged_out_register, "Register", 0, NULL, app);
    //
    ...
    app->variable_item_logged_in_settings_about =
        variable_item_list_add(app->variable_item_list_logged_in_settings, "About", 0, NULL, app);
    app->variable_item_logged_in_settings_wifi =
        variable_item_list_add(app->variable_item_list_logged_in_settings, "WiFi", 0, NULL, app);
    //
    app->variable_item_logged_in_wifi_settings_ssid = variable_item_list_add(
        app->variable_item_list_logged_in_settings_wifi, "SSID", 1, NULL, app);
    app->variable_item_logged_in_wifi_settings_password = variable_item_list_add(
        app->variable_item_list_logged_in_settings_wifi, "Password", 1, NULL, app);
