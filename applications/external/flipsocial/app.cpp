...
FlipSocialApp::FlipSocialApp() {
    ...
    if(!easy_flipper_set_submenu(
           &submenu, FlipSocialViewSubmenu, VERSION_TAG, callbackExitApp, &viewDispatcher)) {
...
bool FlipSocialApp::loadFileChunk(
    const char* filePath,
    char* buffer,
    size_t sizeOfChunk,
    uint8_t iteration) {
