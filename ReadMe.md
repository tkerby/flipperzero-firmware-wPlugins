...
## Latest Updates - [PATREON: Latest Releas RM0220-2136-0.420.0-4e452fd](https://www.patreon.com/RogueMaster?filters[tag]=Latest%20Release) 

- Last Synced/Checked OFW, changes in [commits](https://github.com/flipperdevices/flipperzero-firmware/commits/dev): `2025-02-20 21:36 EST`
- Last Synced/Checked Unleashed, changes in [changelog](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/blob/420/CHANGELOG.md): `2025-02-20 21:36 EST`
...
- Added: [Smartra VIN2PIN v1.0 (By evillero)](https://github.com/evillero/smartra_vin2pin)
- Updated: [Solitaire v2.0.2 (By doofy-dev)](https://github.com/doofy-dev/flipper_solitaire)
...
- OFW: [BadUSB: Mouse control #4004 (By jetrp1)](https://github.com/flipperdevices/flipperzero-firmware/pull/4004)
- OFW: [vscode: disabled auto-update for clangd #4122 (By hedger)](https://github.com/flipperdevices/flipperzero-firmware/pull/4122)
- OFW: [Faster di card reading #4087 (By bettse)](https://github.com/flipperdevices/flipperzero-firmware/pull/4087) (Already In RM)
- OFW: [Fixed repeat in subghz tx_from_file command #4099 (By Jnesselr)](https://github.com/flipperdevices/flipperzero-firmware/pull/4099)
- [Game Mode updated to extend Dummy Mode instead of being its own mode (By RogueMaster)](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/commit/2df000c3bc8941b86b059bcd5298f8c5cbe8fe0d)
- Updated: [DeadZone v0.1 (By retrooper)](https://github.com/retrooper/deadzone)
- UL: [SubGHz: Fix GangQi protocol (By DoberBit and mishamyte) (They spent 2 weeks on this!)](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/commit/b96ae590a11fe1b67a7b119817f661863a4befd2)
- UL: [SubGHz: Came Atomo button hold simulation with full cycle simulation (to allow proper pairing with receiver) (By xMasterX)](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/commit/2e0e7e798c20ffe307a9ba064e36f58c5aba2945)
- UL: [Infrared Fixes (By xMasterX)](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/commit/c9427866b2fd5023d3079f01706c7efb6ecceff4)
- Updated: [USB HID Autofire v0.6 (By pbek)](https://github.com/pbek/usb_hid_autofire)
- Added: [Timer v0.1 (By nagamine-git)](https://github.com/nagamine-git/flipperzero_timer_app)
- Updated: [Metroflip v0.7 (By luu176)](https://github.com/luu176/Metroflip)
- Updated: [GB Printer v0.5 (By kbembedded)](https://github.com/kbembedded/flipper-gb-printer) `Req: GB Link Cable / Malveke`
- Added: [LIDAR Emulator v0.1 (By regaly)](https://github.com/regaly/flipperzero-lidar_emulator)
- OFW TO ADD: [Storage: remove LFS #3577](https://github.com/flipperdevices/flipperzero-firmware/pull/3577) [FuriEventLoop Pt.2 #3703](https://github.com/flipperdevices/flipperzero-firmware/pull/3703) [#3824](https://github.com/flipperdevices/flipperzero-firmware/pull/3824) [#3836](https://github.com/flipperdevices/flipperzero-firmware/pull/3836) [#3834](https://github.com/flipperdevices/flipperzero-firmware/pull/3834) [#3837](https://github.com/flipperdevices/flipperzero-firmware/pull/3837) [#3849](https://github.com/flipperdevices/flipperzero-firmware/pull/3849) [#3879](https://github.com/flipperdevices/flipperzero-firmware/pull/3879) [#3875](https://github.com/flipperdevices/flipperzero-firmware/pull/3875) [#3863](https://github.com/flipperdevices/flipperzero-firmware/pull/3863) [#3866](https://github.com/flipperdevices/flipperzero-firmware/pull/3866) [#3865](https://github.com/flipperdevices/flipperzero-firmware/pull/3865) [#3887](https://github.com/flipperdevices/flipperzero-firmware/pull/3887) [#3892](https://github.com/flipperdevices/flipperzero-firmware/pull/3892) [#3909](https://github.com/flipperdevices/flipperzero-firmware/pull/3909) [#3881](https://github.com/flipperdevices/flipperzero-firmware/pull/3881) [#3942](https://github.com/flipperdevices/flipperzero-firmware/pull/3942) [#3841](https://github.com/flipperdevices/flipperzero-firmware/pull/3841) [#3950](https://github.com/flipperdevices/flipperzero-firmware/pull/3950) [#3952](https://github.com/flipperdevices/flipperzero-firmware/pull/3952) [#3958](https://github.com/flipperdevices/flipperzero-firmware/pull/3958) [#3963](https://github.com/flipperdevices/flipperzero-firmware/pull/3963) [#3971](https://github.com/flipperdevices/flipperzero-firmware/pull/3971) [#3961](https://github.com/flipperdevices/flipperzero-firmware/pull/3961) [#3906](https://github.com/flipperdevices/flipperzero-firmware/pull/3906) [#3978](https://github.com/flipperdevices/flipperzero-firmware/pull/3978) [#3980](https://github.com/flipperdevices/flipperzero-firmware/pull/3980) [#3979](https://github.com/flipperdevices/flipperzero-firmware/pull/3979) [#4040](https://github.com/flipperdevices/flipperzero-firmware/pull/4040) [#3996](https://github.com/flipperdevices/flipperzero-firmware/pull/3996) [#4043](https://github.com/flipperdevices/flipperzero-firmware/pull/4043) [#4075](https://github.com/flipperdevices/flipperzero-firmware/pull/4075) [#4109](https://github.com/flipperdevices/flipperzero-firmware/pull/4109) [#4090](https://github.com/flipperdevices/flipperzero-firmware/pull/4090) [#4103](https://github.com/flipperdevices/flipperzero-firmware/pull/4103)
...
- [Cross Remote v3.2 (By leedave)](https://github.com/leedave/flipper-zero-cross-remote)
