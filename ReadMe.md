...
- Updated: [Simultanious UHF RFID Reader v1.1 (By RileyHaffner)](https://github.com/haffnerriley/Simultaneous-UHF-RFID-FlipperZero) `Req: M6e Nano UHF RFID Reader & Raspberry Pi Zero` [EPC Read Menu Fixes #11 (By haffnerriley)](https://github.com/haffnerriley/Simultaneous-UHF-RFID-FlipperZero/pull/11)
