...
- Patreon Build Update:  [Doom animation (By doomwastaken) Added to Stock, Minimal and Manifest Switcher builds. Updated Dolphin animation set (By RogueMaster)](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/commit/)
- [Removed G0G374 & OPxFlipper animations from Minimal animations set (By RogueMaster)](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/commit/)
