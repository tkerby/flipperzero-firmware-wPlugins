...
## Latest Updates - [PATREON: Latest Release RM0305-2306-0.420.0-21d447c](https://www.patreon.com/RogueMaster?filters[tag]=Latest%20Release)

- Last Synced/Checked OFW, changes in [commits](https://github.com/flipperdevices/flipperzero-firmware/commits/dev): `2025-03-05 23:06 EST`
- Last Synced/Checked Unleashed, changes in [changelog](https://github.com/RogueMaster/flipperzero-firmware-wPlugins/blob/420/CHANGELOG.md): `2025-03-05 23:06 EST`
...
- Updated: [BLE Killer v1.1 (By H4lo)](https://github.com/H4lo/flipper_zero_ble_killer) `Req: ESP32` [UART Changes (By ZhaiRenGaiZaoJia)](https://github.com/ZhaiRenGaiZaoJia/H4lo_BLE-Killer)
- Updated: [Key Copier v1.3 (By zinongli)](https://github.com/zinongli/KeyCopier) [Version 1.3: UI Improvements #32 (By Offreds)](https://github.com/zinongli/KeyCopier/pull/32)
- Updated: [DeadZone v0.2 (By retrooper)](https://github.com/retrooper/deadzone)
- Updated: [Lab401/Light MESSENGER v1.3 (By tixlegeek)](https://github.com/lab-401/fzLightMessenger/tree/main/401lightMessengerApp)
- Updated: [Portal of Flipper v1.2 (By bettse)](https://gitlab.com/bettse/portal_of_flipper) [Support for emulating xbox 360 portals & Use the backlight and RGB led to emulate the portals LEDs (By sanjay900)](https://github.com/sanjay900/portal_of_flipper)
- Updated: [FindMy Flipper v3.5.1 (By MatthewKuKanich)](https://github.com/MatthewKuKanich/FindMyFlipper) [Add initial support for Google's Find My Device network #115 (By aaronjamt)](https://github.com/MatthewKuKanich/FindMyFlipper/pull/115)
