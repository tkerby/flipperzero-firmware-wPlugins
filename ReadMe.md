...
- NFC: Support MIFARE DESFire Transaction MAC file type, fixes reading some EV2+ cards (By Willy-JL)
- NFC: Improvements and fixes for NDEF parsing on MIFARE Classic (By Willy-JL)
