...
#define TEST_ASSERT_TRUE(condition) \
    _unity_assert_true((condition), __LINE__, __FILE__)

#define TEST_ASSERT_FALSE(condition) \
    _unity_assert_false((condition), __LINE__, __FILE__)

#define TEST_ASSERT_NULL(pointer) \
    _unity_assert_null((pointer), __LINE__, __FILE__)

#define TEST_ASSERT_NOT_NULL(pointer) \
    _unity_assert_not_null((pointer), __LINE__, __FILE__)
...
#define TEST_FAIL(message) \
    _unity_test_fail((message), __LINE__, __FILE__)
