# Welcome to LoRadar contributing guide !

Thank you for investing your time in contributing to the app! 

In this guide inspired by the guide of the official [FlipperZero Firmware](https://github.com/flipperdevices/flipperzero-firmware/tree/dev) you will get an overview of the contribution workflow from opening an issue, creating a PR, reviewing, and merging the PR.

## Jump In: A Quick Start for Contributors

See the [README](README.md) and the [doc/](doc/) dir to get an overview of the project. Here are some helpful resources to get you comfortable with open source contribution:
...
- Your PR must comply with [Coding Style](CODING_STYLE.md)
...
Feel free to ask questions in issues if you're not sur
