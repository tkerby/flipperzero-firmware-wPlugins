...
VGMFirmware *vgm_firmware_alloc()
{
    ...
    */
    ...
    snprintf(fw[1].link, sizeof(fw[1].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Screensavers/VideoGameModule/aquarium-VGM.uf2");
    //
    snprintf(fw[2].name, sizeof(fw[2].name), "%s", "Boing Ball - Screensaver");
    snprintf(fw[2].link, sizeof(fw[2].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Screensavers/VideoGameModule/boing_ball-VGM.uf2");
    //
    snprintf(fw[3].name, sizeof(fw[3].name), "%s", "Bouncing Balls - Screensaver");
    snprintf(fw[3].link, sizeof(fw[3].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Screensavers/VideoGameModule/bouncing_balls-VGM.uf2");
    //
    snprintf(fw[4].name, sizeof(fw[4].name), "%s", "DVI Logo Bounce - Screensaver");
    snprintf(fw[4].link, sizeof(fw[4].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Screensavers/VideoGameModule/dvi_logo_bounce-VGM.uf2");
    //
    snprintf(fw[5].name, sizeof(fw[5].name), "%s", "Flying Toasters - Screensaver");
    snprintf(fw[5].link, sizeof(fw[5].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Screensavers/VideoGameModule/flying_toasters-VGM.uf2");
    //
    snprintf(fw[6].name, sizeof(fw[6].name), "%s", "Trippy TV Host - Screensaver");
    snprintf(fw[6].link, sizeof(fw[6].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Screensavers/VideoGameModule/trippy_tvhost-VGM.uf2");
    //
    snprintf(fw[7].name, sizeof(fw[7].name), "%s", "Air Labyrinth - Game");
    snprintf(fw[7].link, sizeof(fw[7].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/AirLabyrinth-VGM.uf2");
    //
    snprintf(fw[8].name, sizeof(fw[8].name), "%s", "Arkanoid - Game");
    snprintf(fw[8].link, sizeof(fw[8].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/Arkanoid-VGM.uf2");
    //
    snprintf(fw[9].name, sizeof(fw[9].name), "%s", "Doom - Game");
    snprintf(fw[9].link, sizeof(fw[9].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/Doom-VGM.uf2");
    //
    snprintf(fw[10].name, sizeof(fw[10].name), "%s", "Doom 8bit - Game");
    snprintf(fw[10].link, sizeof(fw[10].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/Doom_8bit-VGM.uf2");
    //
    snprintf(fw[11].name, sizeof(fw[11].name), "%s", "Flappy Bird - Game");
    snprintf(fw[11].link, sizeof(fw[11].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/FlappyBird-VGM.uf2");
    //
    snprintf(fw[12].name, sizeof(fw[12].name), "%s", "Flight Assault - Game");
    snprintf(fw[12].link, sizeof(fw[12].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/FlightAssault-VGM.uf2");
    //
    snprintf(fw[13].name, sizeof(fw[13].name), "%s", "Flip World - Game");
    snprintf(fw[13].link, sizeof(fw[13].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/FlipWorld-VGM.uf2");
    //
    snprintf(fw[14].name, sizeof(fw[14].name), "%s", "Furious Birds - Game");
    snprintf(fw[14].link, sizeof(fw[14].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/FuriousBirds-VGM.uf2");
    //
    snprintf(fw[15].name, sizeof(fw[15].name), "%s", "Hawaii - Game");
    snprintf(fw[15].link, sizeof(fw[15].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/Hawaii-VGM.uf2");
    //
    snprintf(fw[16].name, sizeof(fw[16].name), "%s", "Pong - Game");
    snprintf(fw[16].link, sizeof(fw[16].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/Pong-VGM.uf2");
    //
    snprintf(fw[17].name, sizeof(fw[17].name), "%s", "T-Rex Runner - Game");
    snprintf(fw[17].link, sizeof(fw[17].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/T-Rex-Runner-VGM.uf2");
    //
    snprintf(fw[18].name, sizeof(fw[18].name), "%s", "Tetris - Game");
    snprintf(fw[18].link, sizeof(fw[18].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/Tetris-VGM.uf2");
    //
    snprintf(fw[19].name, sizeof(fw[19].name), "%s", "Example 8bit - Game");
    snprintf(fw[19].link, sizeof(fw[19].link), "%s", "https://raw.githubusercontent.com/jblanked/pico-game-engine/main/builds/Games/VideoGameModule/example_8bit-VGM.uf2");
