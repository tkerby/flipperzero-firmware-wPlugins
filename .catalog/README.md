...
## Roman Decoder
Roman Decoder is an application that allows users to easily convert Roman numerals to decimals. The app provides an interactive user interface that allows users to select Roman characters through buttons, as well as to see the conversion result instantly with proper validation.
...
- Reset Functionality: Quickly clear input and start over
- Input Validation: Enforces Roman numeral rules and maximum value limits
...
- Up button: clear all input
- Press the back button to delete the last entry.
- Long press the back button to exit the app.
 
 ## Version History
- 0.2 - Added input validation, Roman numeral rules, reset functionality, and improved UI
- 0.1 - Initial release
