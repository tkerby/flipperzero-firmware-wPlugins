...
* **Splash Screen:** Press OK to go to menu
* **Menu Screen:** Use Up/Down to navigate, Right to select
* **Content Screens:** Left for menu

<img alt="Screenshot Splash screen"  src="screenshots/ScreenshotScreenSplash.png" width="40%" />
...
* 2025-11-16 :: **v0.4** :: Conditional questions for the 3rd level, and some basic identification results.
